        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm text-espresso-400 leading-relaxed">
              Reviewing espresso martinis around the globe, one sip at a time. Because life&apos;s too short for bad cocktails.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/" className="hover:text-caramel transition-colors">Home</Link></li>
              <li><Link href="/reviews" className="hover:text-caramel transition-colors">All Reviews</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/admin/login" className="hover:text-caramel transition-colors">Admin Login</Link></li>
            </ul>
          </div>
        </div>

        <div className="border-t border-espresso-800 mt-8 pt-8 text-center text-xs text-espresso-500">
          <p>&copy; {new Date().getFullYear()} Sip Happens. All rights reserved. Drink responsibly.</p>
        </div>
      </div>
    </footer>
  );
